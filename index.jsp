				...
				<div class="signin">
					...
					<!-- pop-up-box -->
									...
									<div id="small-dialog2" class="mfp-hide">
										...
										<div class="signup">
											<form>
                                                                                           <img src="logo/welcome.png"  width="200" height="200" border="2px">
											</form>
									...
									<div id="small-dialog3" class="mfp-hide">
										...
										<div class="signup">
                                                                                    ...
                                                                                    <form method ="post" action="register.jsp">
                                                                                        <input type="text" class="email" name="name" placeholder="Enter Name"  required="required" >
                                                                                        <input type="text" class="email" placeholder="Enter Email" name="email" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?" title="Enter a valid email"/>
                                                                                                <input type="password" placeholder="Password" name="pass" required="required"  title="Minimum 6 characters required" autocomplete="off" />
                                                                                                <input type="text" class="email" name="mobile" placeholder="Mobile Number" maxlength="100" pattern="[1-9]{1}\d{9}" title="Enter a valid mobile number" />
