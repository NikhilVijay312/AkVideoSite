			...
			<div class="container">
				...
				<div class="upload-grids">
					...
					<div class="upload-right">
                                            <div class="polaroid"> <img class="image-style" style="text-align:center"  width="100" height="100" src="../album/<%=code%>.jpg" /></div>
                                            <form method="post" ACTION="song_upload.jsp?code=<%=code%>" name="uploadForm" ENCTYPE='multipart/form-data'>
