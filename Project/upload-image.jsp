...
<% 
    ...
    if(email != null && session.getAttribute(email)!= null ){
        if( request.getParameter("code")== null  || request.getParameter("id")== null) {
...
try
{
FileOutputStream fileOut = new FileOutputStream(request.getRealPath("/")+"/video/"+album_code+"/"+saveFile);
    File fr =  new File(request.getRealPath("/")+"/video/"+album_code);
    fr.mkdir();
