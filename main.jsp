      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			...
			<div class="header-top-right">
				<div class="file">
                                   <a href="upload_song.jsp">Upload</a>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<!-- pop-up-box -->
									...
									<!--//pop-up-box -->
                                                                        <div class="dropdown">
                                                                    <button class="dropbtn"> <img src="logo/aklogo.jpeg"
                                                                                    
                                                                                        width="40" height="35" border="2px"></button>
                                                                    <div class="dropdown-content">
                                                                   
                                                                          <a href="profile_manage.jsp">Manage Profile</a>              
